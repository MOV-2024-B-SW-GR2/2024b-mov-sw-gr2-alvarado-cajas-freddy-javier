...
class ECrudEntrenador : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonBuscarBDD.setOnClickListener {
            ...
            EBaseDeDatos.tablaEntrenador?.consultarEntrenadorPorId(id.text.toString().toInt())?.let { entrenador ->
        ...
        botonEliminarBDD.setOnClickListener {
            val id = findViewById<EditText>(R.id.input_id)
            val respuesta = EBaseDeDatos.tablaEntrenador?.eliminarEntrenador(id.text.toString().toInt()) ?: false
            if (respuesta) mostrarSnackbar("Entrenador eliminado") else mostrarSnackbar("No encontrado")
        }
